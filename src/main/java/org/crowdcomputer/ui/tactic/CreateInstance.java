...
@Runtime(javaDelegateClass = "org.crowdcomputer.impl.tactic.CreateInstance")
@Help(displayHelpShort = "Creates a an Instance", displayHelpLong = "Creates instance of the task")
public class CreateInstance extends AbstractCustomServiceTask {
