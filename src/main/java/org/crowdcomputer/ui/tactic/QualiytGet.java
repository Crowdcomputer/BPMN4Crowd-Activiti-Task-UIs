...
@Runtime(javaDelegateClass = "org.crowdcomputer.impl.tactic.QualityGet")
@Help(displayHelpShort = "Get the quality of an instance", displayHelpLong = "Get the quality of an instance")
public class QualiytGet extends AbstractCustomServiceTask {
